    ...
    results_objects[song_id] = {
      ...
      <div class="row" style="margin:auto;">
          ...
          <div class="col" style="border-style:none;padding:2px;">
              <p class="float-right fit-content" style="margin:0px;color:#ff7b00af;padding-right:10px;">${year}</p>
...
onhashchange = event => {doSaavnSearch(window.location.hash.substring(0))};
